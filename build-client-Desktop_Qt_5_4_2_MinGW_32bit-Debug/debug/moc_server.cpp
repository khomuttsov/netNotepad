...
QT_MOC_LITERAL(3, 12, 1), // "t"
QT_MOC_LITERAL(4, 14, 12), // "onRemoveUser"
QT_MOC_LITERAL(5, 27, 5), // "user*"
QT_MOC_LITERAL(6, 33, 6) // "client"

    },
    "server\0log\0\0t\0onRemoveUser\0user*\0"
    "client"
};
...
void server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onRemoveUser((*reinterpret_cast< user*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&server::log)) {
                *result = 0;
            }
        }
    }
